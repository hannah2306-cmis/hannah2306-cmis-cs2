...
print "My name is ", myName, ". I am ", myAgeInYears, " years old.", " I am exactly", myHeightInMeters, " tall.", " I am going to die when I am", myAgeOfDeath, " years old.", " The average height for an American female at 15 years old is", averageHeightAmericanInMeters, ". One side of a square in feet is", oneSideOfASquareInFeet, ". The length of a rectangle in feet is ", lengthOfARectangleInFeet, ". There are", monthsInYear, " months in a year", ". The height of a rectangle in feet is", heightOfRectangleInFeet, ". My age in months is", myAgeInMonths, "." #print a second message using 5 more of the variables I've created with a comma. 
